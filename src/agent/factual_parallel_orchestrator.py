...
FAILURE_CLASS_METADATA: dict[str, dict[str, Any]] = {
    "routing_classification_failure": {
        ...
        "code_touchpoints": [
            "src/agent/agent_serving.py::_apply_factual_routing_overrides",
            "src/agent/agent_serving.py::_get_case_based_pattern_hint",
            "src/agent/agent_serving.py::GraphRAGAgent.predict",
        ],
        "files_to_modify": [
    ...
    "planner_decomposition_failure": {
        ...
        "code_touchpoints": [
            "src/agent/agent_serving.py::_plan_query",
            "src/agent/agent_serving.py::GraphRAGAgent.predict",
        ],
        "files_to_modify": [
            "src/agent/agent_serving.py",
    ...
    "wrong_primitive_chosen": {
        ...
        "code_touchpoints": [
            "src/agent/agent_serving.py::_apply_factual_routing_overrides",
            "src/agent/agent_serving.py::_plan_from_classification",
        ],
        "files_to_modify": [
            "src/agent/agent_serving.py",
        ],
    ...
    "deterministic_query_failure": {
        ...
        "code_touchpoints": [
            "src/agent/agent_serving.py::_execute_fast_path_stream",
            "src/agent/agent_serving.py::_plan_and_execute_stream",
        ],
        "files_to_modify": [
            "src/agent/agent_serving.py",
        ],
    ...
    "retrieval_failure": {
        ...
        "code_touchpoints": [
            "src/agent/agent_serving.py::_assess_evidence_sufficiency",
            "src/agent/agent_serving.py::_render_abstention_response",
        ],
        "files_to_modify": [
            "src/agent/agent_serving.py",
        ],
    ...
    "entity_resolution_failure": {
        ...
        "code_touchpoints": [
            "src/agent/agent_serving.py::resolve_entity_cached",
            "src/agent/agent_serving.py::_validate_tool_consistency",
        ],
        "files_to_modify": [
            "src/agent/agent_serving.py",
        ],
    ...
    "evidence_selection_failure": {
        ...
        "code_touchpoints": [
            "src/agent/agent_serving.py::_assess_evidence_sufficiency",
            "src/agent/agent_serving.py::_build_provenance_guardrail_block",
            "src/agent/agent_serving.py::_apply_claim_verification",
        ],
        "files_to_modify": [
            "src/agent/agent_serving.py",
        ],
    ...
    "citation_fabrication": {
        ...
        "code_touchpoints": [
            "src/agent/agent_serving.py::_apply_claim_verification",
            "src/agent/agent_serving.py::_apply_provenance_guardrails",
        ],
        "files_to_modify": [
            "src/agent/agent_serving.py",
        ],
    ...
    "provenance_grounding_failure": {
        ...
        "code_touchpoints": [
            "src/agent/agent_serving.py::_build_provenance_guardrail_block",
            "src/agent/agent_serving.py::_apply_provenance_guardrails",
            "src/agent/agent_serving.py::_build_provenance_metadata",
        ],
        "files_to_modify": [
            "src/agent/agent_serving.py",
        ],
    ...
    "reproducibility_instability": {
        ...
        "code_touchpoints": [
            "src/agent/agent_serving.py::_format_canonical_provenance",
            "src/agent/agent_serving.py::_apply_claim_verification",
        ],
        "files_to_modify": [
            "src/agent/agent_serving.py",
    ...
    "missed_cache": {
        ...
        "code_touchpoints": [
            "src/agent/agent_serving.py",
            "src/agent/factual_parallel_orchestrator.py",
        ],
        "files_to_modify": [
            "src/agent/agent_serving.py",
            "src/agent/factual_parallel_orchestrator.py",
    ...
    "overbroad_search": {
        ...
        "change_type": "retrieval_guardrail",
        "code_touchpoints": [
            "src/agent/agent_serving.py::_extract_topic_metadata",
            "src/agent/agent_serving.py::_plan_and_execute_stream",
        ],
        "files_to_modify": [
            "src/agent/agent_serving.py",
            ...
            traced_examples.append(
                {
                    ...
                    "proposed_correction": meta.get(
                        "default_fix",
                        "Investigate the failure path in src/agent/agent_serving.py.",
                    ),
