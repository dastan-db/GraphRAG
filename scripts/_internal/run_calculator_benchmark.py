...
QUESTIONS = [
    ...
    {"id": "ruth_to_david_lineage",
     "question": "Based ONLY on the King James Bible: trace the exact family lineage from Ruth to King David. Name each person in the chain and cite specific verse references from the book of Ruth."},
    {"id": "jacob_across_books",
     "question": "Based ONLY on the King James Bible: in which books is Jacob mentioned by name? For each book, describe one specific thing Jacob did or that happened to him."},
    ...
    {"id": "moses_book_by_book",
     "question": "Based ONLY on the King James Bible: in which books does Moses appear? For each book where he appears, list his key relationships and interactions in that specific book."},
    {"id": "abraham_connections",
     "question": "Based ONLY on the King James Bible: list every person that Abraham has a direct relationship with. State the type of relationship (e.g., PARENT_OF, SPOUSE_OF, SPOKE_TO) and which book it appears in."},
    {"id": "ruth_boaz_path",
